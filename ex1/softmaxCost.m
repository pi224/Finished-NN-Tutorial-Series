...
%size(data)  %9x100
%data = [ones(1,size(data,2));data]; %for base

% Unroll the parameters from theta
theta = reshape(theta, numClasses, inputSize);  %10x9
...
thetagrad = zeros(numClasses, inputSize+1); %10x9
%% ---------- YOUR CODE HERE --------------------------------------
